...
h2. 1.0.21 unreleased

* better selection of HTML5 Boilerplate features in the html5 recipe
* corrected html5 recipe after @paul_irish moved the GitHub repo for html5-boilerplate
...
* update gem 'devise' from 1.4.7 to 1.4.8
