...
if recipes.include? 'testing'
  ...
  prefs[:continuous_testing] = multiple_choice "Continuous testing?", [["None", "none"], ["Guard", "guard"], ["Travis CI", "travis"], ["Guard with Travis CI", "guard-travis"]] unless prefs.has_key? :continuous_testing
