...
h4. Take a Poll; Make Suggestions

Does the rails_apps_composer gem need improvements? "See the poll":http://gopollgo.com/does-the-rails-apps-composer-gem-need-improvements and "offer your suggestions":http://gopollgo.com/does-the-rails-apps-composer-gem-need-improvements.

h4. Alternatives

The rails_apps_composer gem is derived from "Michael Bleigh's RailsWizard gem":https://github.com/intridea/rails_wizard (see "differences":#differences).
...
h4(#differences). Rails_apps_composer Differences
