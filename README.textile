...
bq. "It's like the rails generator but just for the stuff I want, like you've read minds!" -- Michael Martinez
...
h4. Roadmap to Version 2.0

Development is underway for rails_apps_composer 2.0. See the "Roadmap to Version 2.0":http://blog.railsapps.org/post/27141616818/roadmap-for-rails-apps-composer-gem-2-0 and make suggestions.

Does the rails_apps_composer gem need improvements? "See the poll":http://gopollgo.com/does-the-rails-apps-composer-gem-need-improvements.
